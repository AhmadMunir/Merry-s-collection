                ...
                <div class="row">
                  ...
                  <br>
                    <div class="col-lg-11 col-md-11 col-sm-11 col-xs-12" style="margin-bottom:1px;">
                      ...
                      <form action="<?php base_url('admin/transaksi_diterima/edit') ?>" method="post" enctype="multipart/form-data">
                        <br>
                            ...
                            <div class="form-group">
                              ...
                              <input class="form-control <?php echo form_error('resi') ? 'is-invalid':'' ?>" type="text" name="resi" value="<?php echo $tabel_transaksi->resi?>" />
                              <div class="invalid-feedback">
                                <?php echo form_error('resi')?>
                              </div>
                            </div>

                            <input class="btn btn-success" type="submit" name="btn"value="Simpan">
                             <a href="<?php echo site_url('admin/transaksi_diterima') ?>" class="btn btn-primary">Back</a>
                          </form>
                          <table id="trueid">
                            <thead>
                              <tr>
