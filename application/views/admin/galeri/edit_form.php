            ...
            <div class="container-fluid">
                ...
                <br>
                    <div class="col-lg-11 col-md-11 col-sm-11 col-xs-12" style="margin-bottom:1px;">
                      ...
                      <form action="<?php base_url('admin/galeri/add') ?>" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo $tabel_galeri->id_galeri?>"/>
                            <div class="form-group">
                              <label for="gambar">Judul Galeri</label>
                              <input class="form-control <?php echo form_error('judul') ? 'is-invalid':'' ?>"  name="judul" value="<?php echo $tabel_galeri->judul?>" type="text">
                            ...
                            <div class="form-group">
                              ...
                              <input type="hidden" name="old_image" value="<?php echo $tabel_galeri->gambar ?>" />
                              <div class="invalid-feedback">
                             ...
                             <div class="form-group">
                              ...
                              <input class="form-control <?php echo form_error('gambar2') ? 'is-invalid':'' ?>"  name="gambar2" type="file">
                               ...
                               <input type="hidden" name="old_image2" value="<?php echo $tabel_galeri->gambar2 ?>" />
                             <div class="form-group">
                              <label for="gambar3">Gambar 3</label>                              
                              <input class="form-control <?php echo form_error('gambar3') ? 'is-invalid':'' ?>"  name="gambar3" type="file">
                             </div>
                               <input type="hidden" name="old_image3" value="<?php echo $tabel_galeri->gambar3 ?>" />
                             <div class="form-group">
                              ...
                              <input type="hidden" name="old_image4" value="<?php echo $tabel_galeri->gambar4 ?>" />
                             <div class="form-group">
                              ...
                              <input type="hidden" name="old_image5" value="<?php echo $tabel_galeri->gambar5 ?>" />
                                                   

                            
                            <input class="btn btn-success" type="submit" name="btn"value="Simpan">
                            <a href="<?php echo site_url('admin/galeri') ?>" class="btn btn-primary">Back</a>
                          </form>
