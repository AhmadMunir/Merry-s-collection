                ...
                <div class="row">
                  ...
                  <br>
                    <div class="col-lg-11 col-md-11 col-sm-11 col-xs-12" style="margin-bottom:1px;">
                      ...
                      <form action="<?php base_url('admin/custompelanggan_dibuat/edit') ?>" method="post" enctype="multipart/form-data">
                        <br>
                            ...
                            <input class="btn btn-success" type="submit" name="btn"value="Simpan">
                             <a href="<?php echo site_url('admin/custompelanggan_dibuat') ?>" class="btn btn-primary">Back</a>
                          </form>
                          <table id="trueid">
                            <thead>
                              <tr>
