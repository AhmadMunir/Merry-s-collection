...
<body id="page-top">
    ...
    <div class="all-content-wrapper">
        ...
        <form method="post" action="<?php echo base_url('admin/custompelanggan_dibuat'); ?>">
        <!-- DataTables -->
        <br>
        <br>
        <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  <?php foreach ($custompelanggan_dibuat as $key): ?>
                  <tr>
                    <td>
                    ...
                    <td>
                      <a href="<?php echo site_url('admin/custompelanggan_dibuat/edit/'.$key->id_custom)?>" class="btn btn-info">Edit</a>
                    </td>
                  </tr>
                  <?php endforeach; ?>
