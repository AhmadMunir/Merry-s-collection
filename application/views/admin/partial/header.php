                                    ...
                                    <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                <li><a href="<?php echo base_url("register") ?>"><span class="fa fa-home author-log-ic"></span>Register Admin</a>
                                                </li>

                                                <li><a href="<?php echo base_url('user/login/logout') ?>"><span class="fa fa-lock author-log-ic"></span>Log out</a>
                                                </li>
                                            </ul>
                                        </li>
