                                ...
                                <div class="col-md-3 col-sm-4">
                                    <div class="single-product mb-40">
                                        <div class="product-img-content mb-20">
                                            ...
                                            <div class="product-action text-center">
                                                <a href="javascript:void(0);" class="prev_product" data-id="<?php echo $nw->id_barang; ?>"><i class="zmdi zmdi-eye"></i></i></a>
                                                <a href="javascript:void(0);" class="direct_add" data-id="<?php echo $nw->id_barang; ?>"><i class="zmdi zmdi-shopping-cart"></i></i></a>
                                ...
                                <div class="col-md-3 col-sm-4">
                                    <div class="single-product mb-40">
                                        <div class="product-img-content mb-20">
                                            ...
                                            <div class="product-action text-center">
                                                <a href="javascript:void(0);" class="prev_product" data-id="<?php echo $s->id_barang; ?>"><i class="zmdi zmdi-eye"></i></i></a>
                                                <a href="javascript:void(0);" class="direct_add" data-id="<?php echo $s->id_barang; ?>"><i class="zmdi zmdi-shopping-cart"></i></i></a>
