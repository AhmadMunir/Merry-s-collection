    ...
    <div class="modal-body">
      ...
      <div class="row top-buffer">
        ...
        <div class="col col-md-9">
          <select id="country" name="country">
            <option value="<?php echo $id_neg; ?>"><?php echo $country ?></option>
      ...
      <div class="row top-buffer">
        ...
        <div class="col col-md-9">
          ...
          <select name="province" id="province" class="prv">
            <option value="<?php echo $id_prov; ?>"><?php echo $province ?></option>
          </select>
        </div>
      </div>
      ...
      <div class="row top-buffer">
        ...
        <div class="col col-md-9">
          ...
          <select name="city" id="city" class="city">
            <option value="<?php echo $id_kota; ?>"><?php echo $city ?></option>
          </select>
