<script>
  $(document).ready(function(){
    ...
    var new_arriv = pusher.subscribe('home');
    new_arriv.bind('my_event', function(data){
                 ...
                 html+= '<div class="col-md-3 col-sm-4">'+
                          ...
                          '<div class="product-img-content mb-20">'+
                                      ...
                                      '<div class="product-action text-center">'+
                                          ...
                                          '<a href="javascript:void(0);" class="add_cart" data-id="'+data.data[i].id_barang+'"><i class="zmdi zmdi-shopping-cart"></i></i></a>'+
